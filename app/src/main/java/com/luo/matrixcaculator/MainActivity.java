...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    TextView tv_result,tv_equal,tv_add,tv_sub,tv_mult ;
    EditText edt_0,edt_1,edt_2,edt_3,edt_4,edt_5,edt_6,edt_7,edt_8,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_equal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                   ...
                   /* m[0][0] = Double.parseDouble("0" );
                    m[0][1] = Double.parseDouble((edt_1.getText().toString()=="")? "0" :edt_1.getText().toString());
                    m[0][2] = Double.parseDouble((edt_2.getText().toString()=="")? "0" :edt_2.getText().toString());
                    m[1][0] = Double.parseDouble((edt_3.getText().toString()=="")? "0" :edt_3.getText().toString());
                    m[1][1] = Double.parseDouble((edt_4.getText().toString()=="")? "0" :edt_4.getText().toString());
                    m[1][2] = Double.parseDouble((edt_5.getText().toString()=="")? "0" :edt_0.getText().toString());
                    m[2][0] = Double.parseDouble((edt_6.getText().toString()=="")? "0" :edt_0.getText().toString());
                    m[2][1] = Double.parseDouble((edt_7.getText().toString()=="")? "0" :edt_0.getText().toString());
                    m[2][2] = Double.parseDouble((edt_8.getText().toString()=="")? "0" :edt_0.getText().toString());*/
                ...
                switch (flag){
                    case 1:
                        result = MatrixTest.matrixAdd(m, n);break;
                    case 2:
                        result = MatrixTest.matrixSub(m, n);break;
                    case 3:
                        result = MatrixTest.matrixMult(m, n);break;
                }

                tv_result.setText(String.format("%.2f", result[0][0])+"  "+
